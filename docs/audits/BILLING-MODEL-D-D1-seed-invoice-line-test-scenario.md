# BILLING-MODEL-D-D1 — Seed scénario test facturation

## Résultat

- Intervention test : `billing-dd1-intervention`
...
- Le scénario porte `billingModelTestScenario = D-D1`.
...
BILLING-MODEL-D-D2 : passer l'intervention `billing-dd1-intervention` à `terminee` via l'application, puis vérifier `facturesauto` et `lignesfactureauto`.
