# BILLING-MODEL-D-D2 — Seed scénario test facturation

## Résultat

- Intervention test : `billing-dd2-intervention`
...
- Le scénario porte `billingModelTestScenario = D-D2`.
...
BILLING-MODEL-D-D2 : passer l'intervention `billing-dd2-intervention` à `terminee` via l'application, puis vérifier `facturesauto` et `lignesfactureauto`.
