...
function fixEncoding(content) {
  return content
    .split("CrÃ©e").join("Crée")
    .split("liÃ©").join("lié")
    .split("Ã ").join("à")
    .split("payÃ©").join("payé")
    .split("DÃ©jÃ ").join("Déjà")
    .split("Reste Ã ").join("Reste à")
    .split("mÃ©tier").join("métier")
    .split("connectÃ©").join("connecté")
    .split("CrÃ©ation").join("Création")
    .split("Validation mÃ©tier").join("Validation métier")
    .split("Ã©lÃ©ment").join("élément")
    .split("exÃ©cutent").join("exécutent")
    .split("â€¢").join("•");
}
...
let form =
  fixEncoding(read(formPath));

if (!form.includes("InvoiceDocumentActions")) {
  form = form.replace(
`import {
...
if (!form.includes("data-invoice-document-actions")) {
  form = form.replace(
`      {isInvoiceEditForm ? (
        <section
...
console.log("");
console.log("Invoice PDF actions installed.");
console.log("Done.");