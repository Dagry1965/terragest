Write-Host "Generating Terragest Dashboard Notifications Integration..." -ForegroundColor Cyan
  ...
  const loadDashboard = async () => {
    ...
    try {
      ...
      const [
        ...
        AuditService.getLatestByOrganisation(
          organisationId
        ),

        NotificationService.getLatestByOrganisation(
          organisationId
        ),
      ]);
...
Write-Host ""
Write-Host "Terragest Dashboard Notifications Integration generated successfully." -ForegroundColor Green
Write-Host ""
Write-Host "Generated:" -ForegroundColor Yellow
Write-Host "- NotificationCenter in dashboard"
Write-Host "- ERP alerts dashboard"
Write-Host "- Activity + alerts supervision"
Write-Host "- Proactive ERP monitoring"
Write-Host ""