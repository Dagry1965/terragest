$workflowEngine = "C:\Users\Admin\terragest\src\runtime\workflow-ui\WorkflowRuntimeEngine.ts"
$content = [System.IO.File]::ReadAllText($workflowEngine)
$newContent = @'
import {
  maintenanceWorkflow,
}
...
'@
[System.IO.File]::WriteAllText($workflowEngine, $newContent, [System.Text.Encoding]::UTF8)
Write-Host "WorkflowRuntimeEngine remplacé proprement."
