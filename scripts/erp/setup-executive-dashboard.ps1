Write-Host "=== TERRAGEST_V2 - SETUP ERP EXECUTIVE DASHBOARD ===" -ForegroundColor Cyan

New-Item -ItemType Directory -Force "src/components/erp/executive-dashboard" | Out-Null
...
'@ | Set-Content "src/components/erp/executive-dashboard/ERPExecutiveDashboard.tsx"

Write-Host "=== ERP EXECUTIVE DASHBOARD créé avec succès ===" -ForegroundColor Green