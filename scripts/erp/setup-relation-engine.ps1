Write-Host "=== TERRAGEST_V2 - SETUP ERP RELATION ENGINE ===" -ForegroundColor Cyan

New-Item -ItemType Directory -Force "src/core/relations" | Out-Null
...
'@ | Set-Content "src/core/relations/relation-engine.ts"

Write-Host "=== ERP RELATION ENGINE créé avec succès ===" -ForegroundColor Green