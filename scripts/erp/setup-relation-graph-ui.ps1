Write-Host "=== TERRAGEST_V2 - SETUP ERP RELATION GRAPH UI ===" -ForegroundColor Cyan

New-Item -ItemType Directory -Force "src/components/erp/relation-graph" | Out-Null
...
'@ | Set-Content "src/components/erp/relation-graph/ERPRelationGraph.tsx"

Write-Host "=== ERP RELATION GRAPH UI créée avec succès ===" -ForegroundColor Green