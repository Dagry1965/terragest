Write-Host "=== TERRAGEST_V2 - SETUP RUNTIME TIMELINE UI ===" -ForegroundColor Cyan

New-Item -ItemType Directory -Force "src/components/erp/runtime-timeline" | Out-Null
...
'@ | Set-Content "src/components/erp/runtime-timeline/ERPRuntimeTimeline.tsx"

Write-Host "=== RUNTIME TIMELINE UI créée avec succès ===" -ForegroundColor Green