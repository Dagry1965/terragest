$maintenancePage = ".\src\app\(private)\maintenance\page.tsx"
...
"@ | Set-Content $maintenancePage -Encoding UTF8

Write-Host "Page maintenance mise à jour avec ERPDynamicForm."
Write-Host ""
