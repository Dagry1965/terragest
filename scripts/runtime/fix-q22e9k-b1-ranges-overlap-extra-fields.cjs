...
if (!content.includes("[key: string]: unknown;")) {
  fail("Signature souple avec propriétés supplémentaires non appliquée");
}
...
ok("rangesOverlap accepte les champs supplémentaires comme durationMinutes");
ok("Les créneaux adjacents ne seront plus considérés comme chevauchants");

console.log("");
console.log("[Q22E9K_B1_RANGES_OVERLAP_EXTRA_FIELDS_FIX_DONE]");
console.log("");
console.log("Next:");
