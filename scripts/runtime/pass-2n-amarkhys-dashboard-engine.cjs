...
config = config
  ...
  .replaceAll("activité", "activité")
  .replaceAll("financière", "financière")
  .replaceAll("Accès", "Accès")
  .replaceAll("opérations", "opérations")
  .replaceAll("Créer", "Créer")
  .replaceAll("l'activité", "l’activité")
  .replaceAll("confirmés", "confirmés")
  .replaceAll("planifiés", "planifiés")
  .replaceAll("être", "être")
  .replaceAll("à", "à")
  .replaceAll("déjà", "déjà")
  .replaceAll("impayées", "impayées")
  .replaceAll("réglées", "réglées")
  .replaceAll("Échéances", "Échéances")
  .replaceAll("échéances", "échéances")
  .replaceAll("d'échéances", "d’échéances")
  .replaceAll("dépassées", "dépassées")
  .replaceAll("prévus", "prévus")
  .replaceAll("nécessitant", "nécessitant")
  .replaceAll("é venir", "à venir")
  .replaceAll("Payées", "Payées")
  .replaceAll("encaissé", "encaissé")
  .replaceAll("payées", "payées")
  .replaceAll("récentes", "récentes")
  .replaceAll("Dernières", "Dernières")
  .replaceAll("créés", "créés")
  .replaceAll("Véhicules", "Véhicules")
  .replaceAll("Rappels à traiter", "Rappels à traiter")
  .replaceAll("exécuter", "exécuter")
  .replaceAll("aujourd'hui", "aujourd’hui")
  .replaceAll("l'atelier", "l’atelier")
  .replaceAll("régl", "régl");
