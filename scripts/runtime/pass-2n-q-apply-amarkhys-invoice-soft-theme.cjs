...
/**
 * PASS 2N-Q
 * AMARKHYS Soft Green Backoffice
 * Référence visuelle : page facture AMARKHYS
 */
...
`export const amarkhysPetronasTheme: ERPWorkspaceThemeTokens = {
  ...
  description:
    "Thème backoffice AMARKHYS inspiré de la page facture : fond clair doux, cartes blanches, vert PETRONAS léger et tableaux lisibles.",
...
console.log("PASS 2N-Q OK: AMARKHYS invoice soft green style applied globally.");