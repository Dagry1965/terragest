...
const serviceFile = path.join(
  serviceDir,
  "RuntimeStockMovementService.ts"
);
...
const serviceContent = `import { RuntimeDataBinding } from "@/runtime/data-binding/RuntimeDataBinding";
...
const indexContent = `export { RuntimeStockMovementService } from "./RuntimeStockMovementService";
`;

writeFile(serviceFile, serviceContent);
writeFile(indexFile, indexContent);

console.log("OK: RuntimeStockMovementService créé.");