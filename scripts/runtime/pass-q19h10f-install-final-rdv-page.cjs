...
backup(componentPath, ".bak-q19h10f-final-rdv-page");
backup(pagePath, ".bak-q19h10f-final-rdv-page");

write(componentPath, String.raw`"use client";
...
console.log("");
console.log("[Q19H10F_DONE] Final AMARKHYS RDV page installed.");
console.log("");
console.log("Next:");
