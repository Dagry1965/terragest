...
const TAG = "q21f-a10-receptions-stock-list-columns";
...
console.log("[Q21F_A10_DONE] receptionsstockauto list columns harmonized.");
console.log("");
...
console.log("  test /receptionsstockauto");