...
const backupPath = `${targetPath}.bak-q22e9n-c6d-safe-rewrite`;
...
fs.writeFileSync(targetPath, audit, "utf8");

console.log("");
console.log("[Q22E-9N-C6-D] DONE");
console.log(`[BACKUP] ${path.relative(ROOT, backupPath).split(path.sep).join("/")}`);
console.log(`[UPDATED] ${TARGET}`);
console.log("");
console.log("Next:");
console.log("node .\\scripts\\runtime\\audit-q22e9n-c-scheduling-settings-service-action-readiness.cjs");