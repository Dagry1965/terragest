...
ensureDir("src/runtime/operational");
...
write("src/runtime/operational/RuntimeOperationalDataResolver.ts", resolver);
write("src/runtime/operational/index.ts", index);

console.log("");
console.log("[DONE] Q2-D-C-B RuntimeOperationalDataResolver foundation créée.");
console.log("");
console.log("Next:");
