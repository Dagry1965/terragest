...
const report = `# Q2-H-B — Test visuel manuel des pages opérationnelles
...
fs.writeFileSync(
  path.join(reportDir, "Q2-H-B-operational-pages-visual-manual-test.md"),
  report,
  "utf8"
);

console.log("[WRITTEN] docs/audits/Q2-H-B-operational-pages-visual-manual-test.md");
console.log("[RESULT] Q2-H-B manual visual test documented.");
