...
if (!fs.existsSync(filePath)) {
  fail("interventionsauto.module.ts not found");
}

let content = read(filePath);
const backupPath = filePath + ".bak-q2j-c-normalize-interventions-operational-table";
...
const checks = [
  {
    label: "interventionsauto keeps operational table",
    ok: updatedTable.includes("fields:"),
  },
  {
    label: "interventionsauto visible fields normalized",
    ok:
      ...
      updatedTable.includes('"kilometrage"') &&
      updatedTable.includes('"coutTotal"') &&
  ...
  {
    label: "rendezVous relation label preserved",
    ok:
      updatedTable.includes("rendezVousId:") &&
  ...
  {
    label: "interventionsauto keeps kpis",
    ok: updatedOperational.includes("kpis:"),
  },
  {
    label: "interventionsauto keeps rightPanel",
...
console.log("");
console.log("[Q2-J-C] Normalize interventionsauto operational table metadata");
console.log("");
...
console.log("");
console.log("[DONE] interventionsauto operational table normalized.");
console.log("");
console.log("Next:");
