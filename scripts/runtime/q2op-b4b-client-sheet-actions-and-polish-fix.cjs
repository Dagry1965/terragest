...
const backupPath = `${fullPath}.bak-q2op-b4b-actions-polish`;
...
/**
 * 2. Add contextual href constants.
 */
...
console.log("[Q2-OP-B4B] Client sheet business actions and visual polish applied.");
console.log("Next:");
