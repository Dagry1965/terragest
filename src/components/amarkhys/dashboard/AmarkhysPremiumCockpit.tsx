    ...
    <section className="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-[1fr_1.05fr_0.75fr]">
      ...
      action={
       <div ref={revenueMenuRef} className="relative">
        <button
         ...
         className="rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-xs font-black uppercase tracking-[0.18em] text-slate-300 transition hover:border-amber-400/20 hover:bg-amber-400/10 hover:text-amber-100"
     ...
     >
      <div className="mt-6 flex flex-wrap items-center justify-between gap-4 text-sm text-slate-300">
       <div className="flex rounded-2xl border border-amber-400/20 bg-amber-500/10 p-1">
        {[7, 30, 90].map((period) => (
         <button
          key={period}
          type="button"
